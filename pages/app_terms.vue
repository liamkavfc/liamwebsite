  ...
  <div class="container-fluid blocks">
    ...
    <div id="secondBlock" class="block">
      <p>
        ...
        other intellectual property rights related to it, still belong to Liam
        Kenny.
      </p>
      <p>
        Liam Kenny is committed to ensuring that the app is as useful and
      ...
      <p>
        The Anywhere2Go app stores and processes personal data that you have
        ...
        features and it could mean that the Anywhere2Go app won’t work properly
        or at all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Liam Kenny will
        ...
        Wi-Fi, or provided by your mobile network provider, but Liam Kenny
      ...
      <p>
        Along the same lines, Liam Kenny cannot always take responsibility for
        ...
        avail the Service, Liam Kenny cannot accept responsibility.
      </p>
      <p>
        With respect to Liam Kenny’s responsibility for your use of the app,
        ...
        make it available to you. Liam Kenny accepts no liability for any loss,
      ...
      <p>
        ...
        to keep using the app. Liam Kenny does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2021-08-25</p>
      <p><strong>Contact Us</strong></p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at lksoftwaredevelopment@outlook.com.
      </p>
      <p>
